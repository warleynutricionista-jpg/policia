		...
		<>
			{props.row.type === "date" && (
				<DatePicker
					...
					icon={
						props.row.icon && (
							<FontAwesomeIcon fixedWidth icon={props.row.icon} />
						)
					}
					minDate={
						props.row.min ? new Date(props.row.min) : undefined
					}
					maxDate={
						props.row.max ? new Date(props.row.max) : undefined
					}
				/>
			)}
