				...
				<HoverCard.Target>
					...
					>
						<Group position="apart" w="100%" noWrap>
							...
							{(button.menu || button.arrow) &&
								button.arrow !== false && (
									<Stack
										className={classes.buttonArrowContainer}
									>
										<i
											className={`fa-solid fa-fw fa-chevron-right`}
										/>
									</Stack>
								)}
						</Group>
					...
					{Array.isArray(button.metadata) ? (
						...
						<>
							{typeof button.metadata === "object" &&
								Object.entries(button.metadata).map(
									(
