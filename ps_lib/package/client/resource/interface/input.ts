...
export const inputDialog: inputDialog = async (heading, rows) =>
	await exports.ps_lib.inputDialog(heading, rows);

export const closeInputDialog = () => exports.ps_lib.inputDialog();
