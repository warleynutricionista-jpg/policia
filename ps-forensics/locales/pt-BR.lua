return {
    ...
    evidence = {
        ...
        errors = {
            ...
            no_permission_transfer = 'Sem permissão para transferir custódia de evidência',
            register_failed = 'Falha ao registrar evidência',
            invalid_id = 'ID de evidência inválido',
            ...
            invalid_status = 'Status de evidência inválido',
            invalid_status_transition = 'Transição de status inválida para cadeia de custódia',
            no_update = 'Nenhuma atualização informada para a evidência',
            ...
            analysis_notes_required = 'Informe observações obrigatórias para abertura/fechamento de análise',
        ...
        custody = {
            ...
            transfer_default_note = 'Transferência formal de custódia registrada',
        },
        category = {
            balistica = 'Balística',
            biologica = 'Biológica',
